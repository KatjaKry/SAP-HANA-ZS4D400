...
CLASS lcl_connection DEFINITION.
  ...
  PRIVATE SECTION.
    ...
    CLASS-DATA airports TYPE tt_airports.   "Statisches Attribut. Interne Tabelle für Flughafen
...
CLASS lcl_connection IMPLEMENTATION.
  ...
  METHOD class_constructor.   "Hier wird die Interne Tabelle mit Daten gefüllt.
    SELECT FROM /dmo/airport FIELDS airport_id, name INTO TABLE @airports.
  ...
  METHOD get_output.
    ...
    APPEND |Connection: { connection_id }| TO r_output.
                              "Flughafenkurzel                "Flughafenname (ausgelesen per Tabellenausdruck)
